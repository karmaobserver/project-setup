...
import com.aleksejmakaji.filefinder.data.repository.UserRepository
import com.aleksejmakaji.filefinder.data.repository.source.UserLocalDataSource
import com.aleksejmakaji.filefinder.data.room.FileFinderDatabase
...
val dataKoinModule = module {
    ...
    fun provideDataBase(application: Application): FileFinderDatabase {
        return Room.databaseBuilder(application, FileFinderDatabase::class.java, "file_finder.db")
